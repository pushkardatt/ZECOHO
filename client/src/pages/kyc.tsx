...
export default function KYC() {
  ...
  useEffect(() => {
    if (kycApplication && isEditing) {
      ...
      setKycDocuments({
        propertyOwnership:
          (kycApplication.propertyOwnershipDocs as any[]) || [],
        ...
        safetyCertificates:
          (kycApplication.safetyCertificateDocs as any[]) || [],
      });
    }
      ...
      try {
        ...
        if (
          ...
          toast({
            ...
            description:
              "Please enter a valid Indian PIN code or manually enter city and state.",
            variant: "destructive",
          });
        }
      } catch (error) {
        ...
        <Card className="max-w-md w-full">
          ...
          <CardContent className="space-y-4">
            <div className="text-center text-muted-foreground">
              <p className="mb-4">
                We're reviewing your application. You'll be notified once the
                review is complete.
              </p>
              <p className="mb-4">
            ...
            <div className="flex gap-2">
              ...
              <Button className="flex-1" asChild data-testid="button-back-home">
      ...
      <div className="min-h-screen flex items-center justify-center bg-muted/50 p-4">
        <Card className="max-w-md w-full">
          ...
          <CardContent className="space-y-4">
            <div className="text-center text-muted-foreground">
              <p className="mb-4">
                We've received your owner verification application and our team
                will review it carefully.
              </p>
              <p className="mb-4">
                You'll receive an email within{" "}
                <strong>2-3 business days</strong> regarding your verification
                status.
              </p>
              <p className="mb-2">
            ...
            <Form {...form}>
              ...
              >
                ...
                {(!isEditing ||
                  ...
                  <div
                    className={`space-y-4 ${isEditing && hasTargetedRejection && flaggedSections.has("personal") ? "p-4 border-2 border-red-300 dark:border-red-700 rounded-lg bg-red-50/50 dark:bg-red-900/10" : ""}`}
                  >
                ...
                {(!isEditing ||
                  ...
                  <div
                    className={`space-y-4 ${isEditing && hasTargetedRejection && flaggedSections.has("business") ? "p-4 border-2 border-red-300 dark:border-red-700 rounded-lg bg-red-50/50 dark:bg-red-900/10" : ""}`}
                  >
                    <div className="flex items-center gap-2 mb-4">
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <p className="text-xs text-muted-foreground mt-1">
                            Enter PIN code to auto-fill city and state, or skip
                            and enter manually
                          </p>
                          <FormMessage />
                        </FormItem>
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            ...
                            <FormControl>
                              <Input
                                placeholder="Grand Hotels Pvt Ltd"
                                {...field}
                ...
                {(() => {
                  const documentSections: KycSectionId[] = [
                    "propertyOwnership",
                    "identityProof",
                    "businessLicense",
                    "noc",
                  ...
                  const hasAnyDocumentFlagged = documentSections.some((s) =>
                    flaggedSections.has(s),
                  );
                  const showDocuments =
                    !isEditing ||
                    !hasTargetedRejection ||
                    hasAnyDocumentFlagged;

                  if (!showDocuments) return null;

                  return (
                    <div
                      className={`space-y-4 ${isEditing && hasTargetedRejection && hasAnyDocumentFlagged ? "p-4 border-2 border-red-300 dark:border-red-700 rounded-lg bg-red-50/50 dark:bg-red-900/10" : ""}`}
                    >
                      <div className="flex items-center gap-2 mb-4">
                      ...
                      <KycDocumentUploader
                        ...
                        flaggedCategories={
                          isEditing && hasTargetedRejection
                            ? documentSections.filter((s) =>
                                flaggedSections.has(s),
                              )
                            : undefined
                        }
